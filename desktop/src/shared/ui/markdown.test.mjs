...
function buzzDeepLinkUrlTransform(value, key) {
  ...
  if (isChannelLink(value)) return value;
...
test("buzzDeepLinkUrlTransform: preserves buzz://channel href", () => {
  const html = renderMarkdown(
...
test("buzzDeepLinkUrlTransform: rejects malformed buzz://channel href", () => {
  const html = renderMarkdown(
